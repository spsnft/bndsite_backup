...
import { X, Trash2, SendHorizontal, Phone, MessageCircle, Instagram, MapPin, CreditCard, ShoppingBag } from "lucide-react"
...
export const Checkout = ({ 
  ...
  const handleSubmit = () => {
    ...
    const whatsappUrl = `https://wa.me/66612345678?text=${encodeURIComponent(msg)}`;
